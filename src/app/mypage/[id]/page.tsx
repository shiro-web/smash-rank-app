        ...
        <div className={classes.userAreaBody}>
          <div>
            ...
            <div className={classes.characterArea}>
              {datas && datas.length > 0 && datas[0]?.characterName ? (
                <div className={classes.characterWrapper}>
                  <div className={classes.characterData}>
                    ...
                    <div className={classes.characterText}>
                      ...
                      <p className={classes.characterRank}>
                  ...
                  <Link href={"/fighters"} className={classes.characterLink}>
                    <img
                      ...
                      alt=""
                    />
                    <p className={classes.characterLinkText}>
                      キャラごとのランキング
                    </p>
                    <img
                ...
                <div className={classes.dataWrapper}>
                  <div className={classes.rankWrapper}>
                    ...
                    <div className={classes.rank}>
                      <p className={classes.rankNumber}>
                        <span className={classes.rankSpan}>{index}位</span>/
                        {count}人中
                      </p>
                    </div>
                  </div>
                  <div className={classes.powerWrapper}>
                    ...
                    <div className={classes.power}>
                      <p className={classes.powerNumber}>
          ...
          <form className={classes.form} action="" onSubmit={handleSubmit}>
            ...
            <Link href={"/info"} className={classes.info}>
              <HelpOutlineIcon
                style={{ fontSize: "16px" }}
          ...
          <div className={classes.example} id="usage">
            ...
            <div className={classes.infoWrapper}>
              ...
              <Image
                ...
                layout="responsive"
              />
              <p className={classes.exampleDescription}>
                上の画像のように、右下のエリアに
                <Image
            ...
            <div className={classes.infoWrapper}>
              ...
              <p className={classes.description}>
                ①で撮ったスクリーンショットをマイページの「投稿する画像を選ぶ」ボタンから投稿します
                <br />
